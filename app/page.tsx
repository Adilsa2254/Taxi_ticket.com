...
// --- Data ---
const stats = [
  { label: "Order Aktif", value: "128", trend: "+12%", icon: <ChartIcon /> },
  { label: "Driver Online", value: "42", trend: "+5", icon: <CarIcon /> },
  { label: "Tingkat Selesai", value: "96%", trend: "+2.4%", icon: <CheckIcon /> },
  { label: "Pendapatan Hari Ini", value: "Rp 8,4 jt", trend: "+18%", icon: <WalletIcon /> },
];
  ...
  return (
    <main className="relative min-h-screen bg-slate-950 text-slate-50 selection:bg-cyan-500/30 overflow-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 py-6 max-w-7xl mx-auto lg:px-10">
        ...
        <div>
          <button className="px-5 py-2.5 text-sm font-medium text-white bg-white/5 hover:bg-white/10 border border-white/10 rounded-full transition-all duration-300 backdrop-blur-md">
            Masuk / Login
          </button>
        </div>
      </nav>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-16 pb-24 lg:px-10 lg:pt-24 lg:pb-32 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
          <button className="w-full sm:w-auto px-8 py-4 rounded-full bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold text-lg transition-all duration-300 shadow-[0_0_40px_rgba(34,211,238,0.4)] hover:shadow-[0_0_60px_rgba(34,211,238,0.6)] hover:-translate-y-1 flex items-center justify-center gap-2 group">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pb-32 lg:px-10">
        <div className="relative rounded-[2.5rem] border border-white/10 bg-slate-900/50 p-4 md:p-8 backdrop-blur-xl shadow-2xl overflow-hidden group hover:border-white/20 transition-colors duration-500">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 relative z-10">
            <div>
              ...
              <p className="text-sm text-slate-400 mt-1">13 Juli 2026 • Update terakhir 1 menit lalu</p>
            </div>
            <div className="flex gap-2">
               ...
               <button className="p-2 rounded-lg bg-white/5 border border-white/10 text-slate-300 hover:text-white transition-colors group-hover:rotate-180 duration-700">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 relative z-10">
            ...
            {/* Orders */}
            <div className="xl:col-span-2 rounded-2xl bg-slate-950/50 border border-white/5 p-6 flex flex-col h-full">
              ...
              <div className="space-y-3 flex-1">
                {rides.map((ride) => (
                  <div key={ride.id} className="group/ride flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-xl bg-white/5 border border-transparent hover:border-white/10 transition-all duration-300 gap-4 hover:bg-white/10">
            ...
            <div className="rounded-2xl bg-cyan-950/20 border border-cyan-500/10 p-6 flex flex-col h-full relative overflow-hidden group/drivers hover:border-cyan-500/30 transition-colors">
              ...
              <div className="flex items-center justify-between mb-6 relative z-10">
                ...
                <span className="text-xs font-bold bg-cyan-500/20 text-cyan-300 px-2.5 py-1 rounded-md border border-cyan-500/20">42 Online</span>
              </div>
                ...
                {drivers.map((driver) => (
                  <div key={driver.name} className="flex items-center justify-between p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300 border border-transparent hover:border-white/5 hover:scale-[1.02]">
                    ...
                    <div className="flex flex-col items-end gap-1">
                       ...
                       <span className="text-[10px] font-medium text-slate-400">{driver.state}</span>
                    </div>
                  </div>
                ))}
              </div>
